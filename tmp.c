...
char	**tmp_map()
{
	...
	map[1] = ft_strdup("110000000000000000010000000000000111");
	map[2] = ft_strdup("110111000000000000010000000000000111");
	map[3] = ft_strdup("11011100000000E000010000000000000111");
